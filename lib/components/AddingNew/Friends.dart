...
class AddNewFriendPage extends StatefulWidget {
  static String id = "add_new_friend";
  const AddNewFriendPage({Key? key}) : super(key: key);

  @override
  State<AddNewFriendPage> createState() => _AddNewFriendPageState();
}

class _AddNewFriendPageState extends State<AddNewFriendPage> {
  @override
  int selected = 0;
...
class _QRViewExampleState extends State<QRViewExample> {
  ...
  addFriend(String uid) async {
    String uidA = homeStore.uid.value;
    if (await APIService.addNewFriend(uidA, uid) == true) {
  ...
  @override
  Widget build(BuildContext context) {
    if (result != null) addFriend(result!.code.toString());
    return Expanded(
      child: Column(
        children: <Widget>[
